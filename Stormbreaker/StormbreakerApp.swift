...
@main
struct StormbreakerApp: App {
    private static let repoURL = URL(string: "https://github.com/Parthee-Vijaya/stormbreaker-mac")!
    private static let newIssueURL = URL(string: "https://github.com/Parthee-Vijaya/stormbreaker-mac/issues/new/choose")!
    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandGroup(replacing: .help) {
                ...
                Button("Stormbreaker på GitHub") { NSWorkspace.shared.open(Self.repoURL) }
            }
        }
