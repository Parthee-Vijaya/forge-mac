...
struct WebView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        controller.add(context.coordinator, name: "storm")
    ...
    static func dismantleNSView(_ webView: WKWebView, coordinator: Coordinator) {
        ...
        controller.removeScriptMessageHandler(forName: "storm")
    ...
    (function () {
      function post(payload) {
        try { window.webkit.messageHandlers.storm.postMessage(payload); } catch (e) {}
      }
