...
// agents (Claude Code, Cline, even nanocoder) DRIVE a Stormbreaker project. Speaks
...
// (tsc --noEmit, classified through Stormbreaker's hardened ErrorClassifier so the agent
