...
/// user can trigger by name. Built-ins ship with Stormbreaker; users drop more as markdown
/// files in `~/.config/forge/skills/` (global) or `<project>/.forge/skills/` (project).
/// Borrowed from nanocoder's skill bundles — adapted to Stormbreaker's prompt-driven model.
