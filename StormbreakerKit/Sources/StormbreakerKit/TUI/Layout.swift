// ─────────────────────────────────────────────────────────────────────────────
// Layout (Part 3, phase 3) — a flexbox-lite split solver + the fixed Stormbreaker screen
...
/// The fixed Stormbreaker screen skeleton: a 1-row header, a body split into a scrollable
...
public struct StormbreakerLayout: Sendable, Equatable {
    ...
    public static func compute(_ size: Size,
                               ...
                               sideWeight: Int = 2,
                               showSide: Bool = true) -> StormbreakerLayout {
        ...
        return StormbreakerLayout(header: header, transcript: transcript, side: side,
