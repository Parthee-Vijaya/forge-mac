...
final class GitServiceTests: XCTestCase {
    ...
    func testOwnerRepoHTTPS() {
        let r = GitService.ownerRepo("https://github.com/Parthee-Vijaya/stormbreaker-mac.git")
        XCTAssertEqual(r?.owner, "Parthee-Vijaya")
        XCTAssertEqual(r?.repo, "stormbreaker-mac")
    }

    func testOwnerRepoSSH() {
        let r = GitService.ownerRepo("git@github.com:Parthee-Vijaya/stormbreaker-mac.git")
        XCTAssertEqual(r?.owner, "Parthee-Vijaya")
        XCTAssertEqual(r?.repo, "stormbreaker-mac")
    }
    ...
    func testGitStatusDerivedFields() {
        ...
        st.remoteURL = "git@github.com:Parthee-Vijaya/stormbreaker-mac.git"
        XCTAssertTrue(st.hasRemote)
        XCTAssertEqual(st.owner, "Parthee-Vijaya")
        XCTAssertEqual(st.repoName, "stormbreaker-mac")
    }
}
