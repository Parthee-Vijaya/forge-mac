...
enum Lessons {
    ...
    static let details: [String: Detail] = [
        ...
        "error": .init(
            detail: "En fejl i koden der forhindrer appen i at virke som den skal. Helt normalt — selv professionelle får dem hele tiden. Forge prøver at rette dem automatisk.",
        ...
        "self-correction": .init(
            detail: "Forge læser fejlmeddelelsen og retter koden selv, helt automatisk — og prøver igen indtil den virker. Du behøver ikke gøre noget.",
            example: "Build fejler → Forge læser fejlen → retter → preview virker igen."),
        "source code": .init(
        ...
        "deploy": .init(
            detail: "At lægge din app ud på internettet, så andre kan åbne den med et link. Indtil da kører den kun lokalt hos dig. Forge klarer hele turen med ét klik.",
        ...
        "checkpoint": .init(
            detail: "Forges egen fortryd-knap: før hver ændring tager den et øjebliksbillede, så du altid kan rulle tilbage hvis noget går galt. Trygt at eksperimentere.",
