...
final class AppModelLogicTests: XCTestCase {
    ...
    func testRepoNameFromHTTPSURL() {
        XCTAssertEqual(AppModel.repoName(from: "https://github.com/Parthee-Vijaya/stormbreaker-mac.git"), "stormbreaker-mac")
    }

    func testRepoNameFromSCPURL() {
        XCTAssertEqual(AppModel.repoName(from: "git@github.com:Parthee-Vijaya/stormbreaker-mac.git"), "stormbreaker-mac")
    }
